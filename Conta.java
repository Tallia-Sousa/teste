...
public class Conta {
    ...
    public Conta(Cliente Cliente) {
        ...
        this.saldo = saldo;
        this.Cliente = Cliente;//this.tipoconta = tipoconta;contador += 1;
    ...
    public String getClienteOpcaoConta(){
        return this.Cliente.getOpcaoConta();
    }

    public String toString() {
        return  "Tipo Da Conta : " +getClienteOpcaoConta() + "\n" +
